<template>
  ...
  <div id="app-todos">
    ...
    <div class="todos">
      <div class="dt-group" v-for="(todos, dt) in getTodosByDate" :key="dt">
        <div class="dt">
          <span>{{ dt + 1 }} 일 :</span>
        ...
        <div class="todo-lt" v-for="(todo, idx) in todos" :key="idx" >
          ...
          <template v-if="!todo.isEdit">
            ...
            <div class="todo-hovered">
              <button class="btn btn-success" @click.stop="onStartEditTodo(todo)">수정</button>
              <button class="btn btn-danger" @click.stop="onDeleteTodo(todo)">삭제</button>
            </div>
